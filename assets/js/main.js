...
function initGalleryGrid() {
    ...
    if (galleryGrid) {
        const galleryImages = [{
                ...
                alt: 'تركيب واجهات زجاج سيكوريت بالرياض'
            },
            {
                src: './assets/images/2.jpg',
                alt: 'أبواب زجاج مقسى فاخرة بالرياض'
            },
            {
                src: './assets/images/3.jpg',
                alt: 'درابزين زجاجي للسلالم والشرفات الرياض'
            },
            {
                src: './assets/images/4.jpg',
                alt: 'كبائن شاور زجاجية عصرية بالرياض'
            },
            {
                src: './assets/images/5.jpg',
                alt: 'واجهات محلات زجاج سيكوريت الرياض'
            },
            {
                src: './assets/images/6.jpg',
                alt: 'فني زجاج سيكوريت محترف بالرياض'
            },
            {
                src: './assets/images/7.jpg',
                alt: 'تركيب زجاج سيكوريت الصناعية القديمة'
            },
            {
                src: './assets/images/8.jpg',
                alt: 'نوافذ زجاج سيكوريت عازلة للصوت والحرارة'
            },
            {
                src: './assets/images/9.jpg',
                alt: 'أعمال زجاج سيكوريت فاخرة بالرياض'
            },
            {
                src: './assets/images/10.jpg',
                alt: 'مؤسسة تركيب زجاج سيكوريت بالرياض'
            },
        ];
        galleryImages.forEach(img => {
            const div = document.createElement('div');
            div.className = 'overflow-hidden rounded-xl shadow hover:shadow-xl transition';
            div.innerHTML = `<img src="${img.src}" alt="${img.alt}" class="w-full h-64 object-cover hover:scale-105 transition duration-500" loading="lazy" />`;
